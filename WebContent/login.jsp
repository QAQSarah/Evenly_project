<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<%@ page language="java" import="com.QAQSarah.model.User"%>
<%
...
<body>
	<div class="container">
		<form name="myForm" class="form-signin" action="login" method="post"
			...
			<h2 class="form-signin-heading">维多利亚的秘密</h2>
			<input id="userName" name="userName" value="${user.userName }"
				type="text" class="input-block-level" placeholder="天使名...">
			<input id="password" name="password" value="${user.password }"
				type="password" class="input-block-level" placeholder="专属密码...">
			<label class="checkbox"> <input id="remember" name="remember"
